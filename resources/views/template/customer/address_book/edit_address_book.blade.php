...
@section('content')
    ...
    <div class="content-header">
        <x-admin.title-and-breadcrumb title="Edit Address"
                                      breadcrumbs='{"Home":"dashboard","Address Book":"address_book.index","Edit Address Book":""}'/>
        <!-- /.content-header -->

        <x-admin.ui.card-form title="Address Details" form-route="address_book.update" form-id="edit_address_book"
