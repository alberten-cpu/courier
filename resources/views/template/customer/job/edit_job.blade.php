@extends('layouts.admin.admin_layout',['title'=>'Edit Job'])
@section('content')
    ...
    <div class="content-header">
        ...
        <x-admin.ui.card-form title="Job Details" form-route="jobs.update" form-id="edit_job" autocomplete
                ...
                <div class="row px-3">
                    ...
                    <div class="col-12">
                        <x-admin.ui.input label="Customer" type="hidden" name="customer"
                                          ...
                                          placeholder="Customer" required :value="auth()->id()"/>
                    </div>
                    <div class="col-12">
        ...
        @push('scripts')
            <script>
                ...
                function getAddressBook(customerId, type) {
                    $.ajax({
                        url: '{{ Helper::getRoute('jobs.getAddressBook') }}',
                        type: 'post',
                ...
                function customerContactAutocomplete(customerId = null) {
                    $("#customer_contact").autocomplete({
                        source: function (request, response) {
                            $.ajax({
                                url: "{{ Helper::getRoute('jobs.getCustomerContact') }}",
                                type: 'post',
                                data: {
                                    search: request.term,
                                    id: customerId
