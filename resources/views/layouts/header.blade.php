...
<!-- side nav css file -->
<link href="{{asset('app-assets/css/SidebarNav.min.css')}}" media='all' rel='stylesheet' type='text/css'/>
<!-- //side nav css file -->
 
 <!-- js-->
<script src="{{asset('app-assets/js/jquery-1.11.1.min.js')}}"></script>
...
<!-- Metis Menu -->
<script src="{{asset('app-assets/js/metisMenu.min.js')}}"></script>
...
<script src="{{asset('app-assets/js/pie-chart.js')}}" type="text/javascript"></script>
...
<!-- //pie-chart --><!-- index page sales reviews visitors pie chart -->
	...
	<!-- requried-jsfiles-for owl -->
					...
					<script src="{{asset('app-assets/js/owl.carousel.js')}}"></script>
						<script>
							$(document).ready(function() {
					...
					<ul class="nofitications-dropdown">
						<li class="dropdown head-dpdn">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="#">
								   <div class="user_img"><img src="{{asset('app-assets/images/1.jpg')}}" alt=""></div>
								...
								<li class="odd"><a href="#">
									<div class="user_img"><img src="{{asset('app-assets/images/4.jpg')}}" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
								...
								<li><a href="#">
								   <div class="user_img"><img src="{{asset('app-assets/images/3.jpg')}}" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
								...
								<li><a href="#">
								   <div class="user_img"><img src="{{asset('app-assets/images/2.jpg')}}" alt=""></div>
								   <div class="notification_desc">
									<p>Lorem ipsum dolor amet </p>
									<p><span>1 hour ago</span></p>
									</div>
						...
						<li class="dropdown profile_details_drop">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									<span class="prfil-img"><img src="{{asset('app-assets/images/2.jpg')}}" alt=""> </span> 
									<div class="user-name">
										<p>Admin Name</p>
